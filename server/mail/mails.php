...
$link ="http://www.futbolcarta.com.ar/juego/#/equipo/maccingami/partido/nuevo";
...
for($i=2;$i<count($select3);$i++){
	...
	$mail->SMTPAuth   = true;
       ...
       // $mail->SMTPDebug = true; //muestra errores y mensajes //
        ...
        $cuerpo .= "<center>";
        $cuerpo .= "<h3>Hola <b> ".$nombreJ."</b></h3><br/>";
        $cuerpo .= "Te avisamos que tu equipo: <b>$equipo</b>,<br>";
        $cuerpo .= "<b>Juega este: $diaE $diaN de $mes a las $hora_partido en $lugar_partido!</b><br><br>";
        $cuerpo .= "Es un partido $caracter de fútbol $futbol_partido <br><br>";
        $cuerpo .= "Anotate en el partido ingresando a este link: <br>";
        $cuerpo .= "<a href='$link'>ANOTATE</a><br><br>";
        
        $cuerpo .= "Acordate de poner tu posición y el estado físico! <br><br>";
        $cuerpo .= "<b>$equipo</b> es un equipo de amigos, que juega a divertirse...<br>";
        $cuerpo .= "PERO... con RESPONSABILIDAD, tratá de esta 30' antes de cada partido, para precalentar <br><br>";
        ...
        $mail->Subject = "Juega $equipo, ANOTATE!";
