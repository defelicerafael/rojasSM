 angular.module("TablaLocal",[])
    .directive("tablalocal",function(){
        
        return{
            
            restrict: "E",
            templateUrl: 'directives/tabla/templates/tablaLocal.html',
            scope: {
                tabla:"@"
            },
            link:{
            ...
            controller : function($scope,$element,Sql,$timeout,$cookies,$window){
                $scope.traigoTabla = [];
                $scope.th = [];
                $scope.mostrar = [];
                ...
                if(typeof $cookies.get('user') ==='undefined'){
                    ...
                    //console.log(dtl.log);
                        ...
                        $scope.log = $cookies.get('user');
                        $scope.localogin = $cookies.get('local');
                ...
                $scope.selectBetween =  function(filtro,hasta, de,que){
                 console.log(filtro,hasta, de,que);
